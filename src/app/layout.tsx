...
import './globals.css';
import { FooterForm } from '@/lib/components/FooterForm';
...
export default function RootLayout({
  ...
  return (
    <html lang="es">
      <body className="text-foreground relative bg-neutral-950">
        <main className="relative">
          <header>
            <nav className="mx-auto flex max-w-[1280px] items-center justify-between bg-transparent px-8 py-4">
              <div className="logo">
                <h1>INDIES</h1>
              </div>
              <div className="flex gap-2">
                ...
                <div className="menu-icon">
                  <button className="bg-dark h-full w-full cursor-pointer gap-2 p-3 hover:bg-neutral-900">
                    <svg
                      width="28"
                      height="28"
                      viewBox="0 0 28 28"
